...
add_action('after_setup_theme','italiawp_add_gutenberg_support');
function italiawp_add_gutenberg_support(){
    ...
    add_theme_support('editor-color-palette',
        array(
            array(
                ...
                'color' => get_option('italiawp_colore_primario'),
            ),
            array(
                'name'  => 'Colore Primario Chiaro',
                'slug'  => 'colore-primario-chiaro',
                'color' => get_option('italiawp_colore_primario_chiaro'),
            ),
            array(
                'name'  => 'Colore Primario Scuro',
                'slug'  => 'colore-primario-scuro',
                'color' => get_option('italiawp_colore_primario_scuro'),
            ),
            array(
                'name'  => 'Colore Complementare',
                'slug'  => 'colore-complementare',
                'color' => get_option('italiawp_colore_complementare'),
            )
        )
    );
}
